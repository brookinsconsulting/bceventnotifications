<?php
//
// Definition of EventEndNotification Cronjob
//
...
/*! \file eventendnotification.php
    \brief The cronjob that handles user notification of events ending through email.
*/
...
$ret = $c->sendEventEndNotifications();
print_r( $ret );
